      ...
      <div className="min-h-screen bg-ios-gray flex flex-col">
        <main className="flex-1 flex items-center justify-center p-6">
          <div className="w-full max-w-sm mx-auto text-center animate-fade-in">
            {/* Nuevo logo rectángulo con tamaño más grande */}
            <div className="mb-8">
              <div className="h-40 w-96 mx-auto flex items-center justify-center">
                <img
                  src="/logo_txt_transp.png"
                  alt="Logo"
                  className="w-full h-full object-contain" // Ajuste para que ocupe todo el espacio
                />
              </div>
            </div>
